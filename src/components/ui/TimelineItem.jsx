    ...
    <div className="relative pl-8 pb-12 last:pb-0 group">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 group-hover:border-green-500/30">
        ...
        <div className="flex items-start gap-4 mb-4">
          {/* Espace avatar/logo */}
          <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0 border border-green-200 dark:border-green-800">
            {experience.logo ? (
              <img 
                src={experience.logo} 
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-2">
              ...
              <span className="inline-flex items-center gap-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-sm px-3 py-1 rounded-full font-medium border border-green-200 dark:border-green-800">
                {experience.type}
              </span>
            </div>
        ...
        <div className="flex flex-wrap gap-2">
          {experience.technologies.map((tech, index) => (
            <span
              key={index}
              className="bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 text-xs px-3 py-1 rounded-full border border-green-200 dark:border-green-800"
            >
              {tech}
            </span>
          ))}
