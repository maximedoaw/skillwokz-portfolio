            ...
            <div className="flex flex-col py-4">
              {menuItems.map((item) => (
                <button
                  key={item.name}
                  onClick={() => scrollToSection(item.href)}
                  className="px-4 py-3 text-gray-600 dark:text-gray-300 hover:text-emerald-500 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-left font-medium"
                >
                  {item.name}
                </button>
              ))}
